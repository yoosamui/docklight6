...
# Valid explicit effects: plasma, gnome, slide, fade, slide_fade
autohide_effect =
...
void DockConfigurationManager::reload()
{
    ...
    else
    {
        ...
        else if (hover_effect == "magnified")
        {
            candidate.settings.set_hover_effect(
        ...
        else if (autohide_effect == "slide_fade")
        {
            candidate.settings
                .set_autohide_effect(
        ...
        else
        {
            g_warning(
                ...
                "expected empty, plasma, gnome, slide, "
                "fade, or slide_fade; "
                "keeping the "
                "platform default",
